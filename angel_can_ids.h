 ...
 * - WHS1: [*** 0100 00**] -> Front Right Sensor
 * - WHS2: [*** 0100 01**] -> Front Left Sensor
 * - WHS3: [*** 0100 10**] -> Rear Right Sensor
 * - WHS4: [*** 0100 11**] -> Rear Left Sensor
 */

#define WHS_VCU_DISP_1 0x340 //Stores displacement and time of wheel 1
#define WHS_VCU_IMU_1 0x341 //Stores speed and time of wheel 1
#define WHS_DSH_FAULT_MSG_1 0x343 //Stores fault info of whs
#define WHS_VCU_DISP_2 0x344 //Stores displacement and time of wheel 2
#define WHS_VCU_IMU_2 0x345 //Stores speed and time of wheel 2
#define WHS_DSH_FAULT_MSG_2 0x347 //Stores fault info of whs
#define WHS_VCU_DISP_3 0x348 //Stores displacement and time of wheel 3
#define WHS_VCU_IMU_3 0x349 //Stores speed and time of wheel 3
#define WHS_DSH_FAULT_MSG_3 0x34B //Stores fault info of whs
#define WHS_VCU_DISP_4 0x34C //Stores displacement and time of wheel 4
#define WHS_VCU_IMU_4 0x34D //Stores speed and time of wheel 4
#define WHS_DSH_FAULT_MSG_4 0x34F //Stores fault info of whs
